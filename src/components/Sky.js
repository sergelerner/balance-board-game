function drawSky(node) {
	...
	var images = [];
	var loadBackground = function(canvas) {
		canvas.width = window.innerWidth;
		canvas.height = window.innerHeight;
		...
		images = preload({
				background: 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/216617/89275-space-stars-artwork.jpg',
				...
				startTime = Date.now();
				backgroundAnimation = w.setAnimation( draw, canvas );
